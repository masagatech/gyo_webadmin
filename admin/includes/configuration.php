...
error_reporting( E_ERROR );
	...
	function _price2( $amount ){
		return 'INR '.round( $amount, 2 );
	}
	function _km( $km ){
		echo $km.' Km';
	}
	...
	$globalCharges = array(
		...
		'ride_time_charge' => 'Ride Time Charge (Per Minute)',
		'ride_time_pick_charge' => 'Ride Time Pick Charge (Per Minute)',
	...
	$globEmailTypes = array(
		...
		'user_manual_wallet_update' 	=> 'User : Manual Wallet Update',
		'user_registration' 			=> 'User : Registration',
		'user_otp_verified' 			=> 'User : OTP Verified',
		'user_forgot_password' 			=> 'User : Forgot Password',
		'user_reset_password' 			=> 'User : Reset Password',
