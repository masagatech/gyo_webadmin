...
$page_title = "Track Customer";
$page = "customer_warroom";
$title2 = "Customer Warroom";
$table = 'tbl_user';
			...
			<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						<div class="header">
							<h3>
								 <?php echo ucfirst( $title2 );?> <a href="javascript:;" class="fright">
								<button class="btn btn-primary" type="button" onclick="load_customer_warroom();">Refresh</button>
								</a> 
							...
							<form name="frm" id="frm_warroom" action="" method="get" >
								<label style="margin-left:5px">
									...
									<div class="pull-left" style="">
										<div>
											<select class="select2" name="srch_filter_city" id="srch_filter_city" onChange="load_customer_warroom();">
...
<script type="text/javascript" >
	...
	function load_customer_warroom(){
		
		// showLoder();
		jQuery.ajax({
			method	: "POST",
			url		: "<?php echo ADMIN_URL?>ajax_operations.php?mode=load_customer_warroom",
